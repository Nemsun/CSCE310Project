...
<div class="main-container margin-left-280">
    ...
    <div class="table-wrapper">
        <div class="flex flex-col align-end min-width-180">
            <button class="add-btn" onclick="window.location.href='insert_class.php'">Add Class</button>
        </div>
        <h3>Classes</h3>
        <?php
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<input type=\"hidden\" name=\"ce_num\" value=\"" . $row['ClassEnrollmentID'] . "\">";
                            echo "<button type=\"submit\" name=\"delete-class\" class=\"table-btn delete-btn\" onclick=\"return confirm('Are you sure you want to delete this class?');\">Delete</button>";
                            echo "</form>";
                            echo "</td>";
                            echo "</tr>";
                        }
