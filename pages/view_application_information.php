...
<div class="main-container margin-left-280">
    ...
    <form class="edit-form flex flex-col flex-start align-start" action="#" method="post">
        <div class="flex align-center margin-top-10 margin-bot-10">
            ...
            <input class="font-size-l border-radius-12 width-48px text-align-center" id="app-num" type="" placeholder="Application Number" name="app_num" value="<?php echo $appNum; ?>" disabled>
        </div>
        <div class="flex align-center margin-top-10 margin-bot-10">
            <label class="event-label text-black font-size-l pd-10 font-weight-bold" for="program-num">Program Number: </label>
            <input class="font-size-l border-radius-12 width-auto text-align-center" id="program-num" type="" placeholder="Program Number" name="program_num" value="<?php echo $programNum; ?>">
        </div>

        <div class="flex align-center margin-top-10 margin-bot-10">
            <label class="event-label text-black font-size-l pd-10 font-weight-bold" for="program-name">Program Name: </label>
            <input class="font-size-l border-radius-12 pd-20 width-1350px" id="program-name" type="" placeholder="Program Name" name="program_name" value="<?php echo $programName; ?>" disabled>
        </div>

        <div class="flex align-center margin-top-10 margin-bot-10">
            <label class="event-label text-black font-size-l pd-10 font-weight-bold" for="program-desc">Program Description: </label>
            <textarea class="font-size-l border-radius-12 pd-20 width-1300px" id="program-desc" type="" placeholder="Program Description" name="program_desc" disabled><?php echo $programDesc; ?></textarea>
        </div>

        <div class="flex align-center margin-top-10 margin-bot-10">
            <label class="event-label text-black font-size-l pd-10 font-weight-bold" for="uncom-cert">Uncompleted Certificates: </label>
            <textarea class="font-size-l border-radius-12 pd-20 width-1250px" id="uncom-cert" type="" placeholder="Uncompleted Certificates" name="uncom_cert"><?php echo $uncomCert; ?></textarea>
        </div>

        <div class="flex align-center margin-top-10 margin-bot-10">
            <label class="event-label text-black font-size-l pd-10 font-weight-bold" for="com-cert">Completed Certificates: </label>
            <textarea class="font-size-l border-radius-12 pd-20 width-1275px" id="com-cert" type="" placeholder="Completed Certificates" name="com_cert"><?php echo $comCert; ?></textarea>
        </div>

        <div class="flex align-center margin-top-10 margin-bot-10">
            <label class="event-label text-black font-size-l pd-10 font-weight-bold" for="purpose-statement">Purpose Statement: </label>
            <textarea class="font-size-l border-radius-12 pd-20 width-1315px" id="purpose-statement" type="" placeholder="Purpose Statement" name="purpose_statement"><?php echo $purposeStatement; ?></textarea>
        </div>
