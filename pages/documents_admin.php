...
<div class="main-container margin-left-280">
    <h2> You can view all documents as an admin here.</h2>
</div>
...
<div class="margin-left-280">
    ...
    <label for="name">Student UIN:</label>
...
$fileType = $_FILES['file']['type'];
  ...
  mysqli_stmt_bind_param($stmt, 'sss', $fileName, $fileContent, $studentUIN);
